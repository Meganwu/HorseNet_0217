...
def EnergyModel(
 ...
 #       "one_hot": NuclearChargeEmbedding,
    ...
    layers.update(
        {
            ...
            "output_hidden_to_scalar": (
                AtomwiseLinearFinal,
                dict(irreps_out="2x0e", out_field_1=AtomicDataDict.PER_ATOM_ENERGY_KEY, out_field_2=AtomicDataDict.PER_ATOM_CHARGE_KEY),
            ),
        }
    )
