...
def GlobalRescale(
    ...
    if initialize:
        ...
        if len(str_names) > 0:
            print('conpute shofts and scales', str_names)
        ...
        if isinstance(global_scale, str):
            s = global_scale
            print('str_name______scale', str_names, global_scale)
...
def PerSpeciesRescale(
    ...
    if initialize:
        ...
        if isinstance(scales, str):
            ...
            print('str_name______scale', str_names, scales)
        ...
        if isinstance(shifts, str):
            ...
            print('str_name______shifts', str_names, shifts)
