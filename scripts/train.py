...
from utils.versions import check_code_version
...
def fresh_start(config):
    ...
    if config.wandb:
        ...
        from train.trainer_wandb import TrainerWandB

        # download parameters from wandb in case of sweeping
        from utils.wandb import init_n_update
...
def restart(config):
    ...
    if config.wandb:
        from train.trainer_wandb import TrainerWandB
        from utils.wandb import resume
